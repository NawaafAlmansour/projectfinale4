...
// pull in Mongoose model for contact
...
router.get('/contacts', (req, res, next) => {
  ...
  // Option 1 get user's contacts
  Contact.find({})
    .then(contacts => res.status(200).json({contacts: contacts}))
    .catch(next)

  // // Option 2 get user's contacts
  // // must import User model and User model must have virtual for contacts
...
router.post('/contacts', (req, res, next) => {
  ...
  Contact.create(req.body.contacts)
